...
final class Cli {
    ...
    public static void main(String[] args) {
        ...
        longOpts[3] = new LongOpt("help", LongOpt.REQUIRED_ARGUMENT, null, 'h');

        Getopt g = new Getopt("libgenaro-java", args, "u:w:Vvh", longOpts);
        ...
        try {
            genaro = new Genaro(genaroBridge, privKey, passwd);
        } catch (Exception e) {
